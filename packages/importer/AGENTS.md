...
The zero-loss import tooling: official Workchat export scripts (run by the customer on
...
- We own the whole chain: our export scripts produce a well-defined, **encrypted** Workchat
...
- Develop and test against the real fixture in `fixtures/export-workchat-2026-08-29/`
  (local, gitignored).
