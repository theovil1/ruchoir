...
/**
 * Landing page. Beyond confirming the build pipeline, it exercises the full path
 * end to end: a static asset served by the Rust API calls the API's own health
 * endpoint. Replaced by the real app shell later.
 */
